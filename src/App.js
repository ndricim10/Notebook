      ...
      <Router>
        <Routes>
          <Route
            ...
            element={
              // <Layout>
                <Notebook notes={notes} titles={titles} handleChange={handleChange} handleSubmit={handleSubmit} searchQuery={searchQuery} 
          ...
          <Route
            path="/notes/:id"
            element={
              <Note notes={notes} titles={titles} handleChange={handleChange} handleSubmit={handleSubmit} searchQuery={searchQuery} />
            }
          />
        </Routes>
      </Router>
